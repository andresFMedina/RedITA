...
private const val ACTIVIDAD_ID = "publicacionId"
...
class RepositorioReaccion(private val firebase: FirebaseSource) {
    ...
    fun getReaccionesByPublicacionIdYUsuarioUid(publicacionId: String, usuarioUid: String): Query {
        var query = firestoreDB.collection(REACCIONES).whereEqualTo(ACTIVIDAD_ID, publicacionId)
